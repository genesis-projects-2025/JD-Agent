...
export default function FeedbackPage() {
 ...
 <p className="text-[11px] font-medium text-surface-400 tracking-[0.2em]">
 Syncing Feedback...
 </p>
 </div>
 </div>
 ...
 <div className="w-14 h-14 bg-gradient-to-br from-primary-500 to-primary-600 rounded-md flex items-center justify-center shadow-md shadow-primary-500/20 transform rotate-[-3deg] hover:rotate-0 transition-transform duration-300">
 <MessageSquare className="w-7 h-7 text-white" />
 </div>
 <div>
 <h1 className="text-2xl sm:text-5xl font-medium text-surface-900 ">
 Feedback Hub
 </h1>
 ...
 <div className="bg-white px-5 py-4 rounded-md border border-surface-200/60 shadow-sm flex items-center gap-4 flex-1 sm:min-w-[160px]">
 <div className="w-10 h-10 rounded-md bg-orange-100/50 flex items-center justify-center shrink-0">
 <AlertTriangle className="w-5 h-5 text-orange-600" />
 </div>
 <div>
 <p className="text-[11px] font-medium text-surface-500 mb-0.5 whitespace-nowrap">
 Unread
 </p>
 <p className="text-2xl font-medium text-surface-900 leading-none">
 ...
 {feedback.length === 0 ? (
 <div className="bg-white/50 backdrop-blur-xl border border-surface-200/60 rounded-md p-16 text-center shadow-sm">
 <div className="w-20 h-20 bg-surface-100 rounded-md flex items-center justify-center mx-auto mb-6 transform rotate-3">
 ...
 <div
 key={item.id}
 className={`bg-white rounded-[24px] p-6 border transition-all duration-300 group hover:shadow-md hover:-translate-y-1 relative ${
 !item.is_read
 ...
 <span
 className={`px-3 py-1 text-[10px] font-medium rounded-lg flex items-center gap-1.5 w-fit ${
 item.action === "approve"
 ...
 <div>
 <h3 className="text-lg font-medium text-surface-900 leading-snug line-clamp-2 mb-1 group-hover:text-primary-700 transition-colors">
 {item.jd_title}
 </h3>
 ...
 className="flex items-center gap-2 px-4 py-2 bg-primary-50 text-primary-700 hover:bg-primary-100 hover:text-primary-800 rounded-md text-sm font-medium transition-colors group/btn"
 >
 View Document
