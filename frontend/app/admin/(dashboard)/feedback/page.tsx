...
export default function AdminFeedbackInbox() {
 ...
 <div
 className={`w-full md:w-1/3 md:min-w-[320px] bg-white text-sm sm:text-base rounded-md border border-slate-200 shadow-sm flex-col overflow-hidden ${selectedId ? "hidden md:flex" : "flex flex-1 md:flex-none"}`}
 >
 ...
 className={`px-2 sm:px-3 py-1 rounded-md text-[10px] sm:text-[11px] font-medium tracking-wider transition-colors ${
 statusFilter === status
 ...
 <span
 className={`font-medium ${fb.status === "unread" ? "text-slate-900 font-medium" : "text-slate-700"}`}
 >
 {fb.user_name}
 </span>
 ...
 <div
 className={`flex-1 bg-white rounded-md border border-slate-200 shadow-sm overflow-hidden flex-col text-sm sm:text-base ${!selectedId ? "hidden md:flex" : "flex"}`}
 >
 {selectedFeedback ? (
 <>
 ...
 <div className="w-12 h-12 bg-blue-100 text-blue-700 rounded-md flex items-center justify-center font-medium text-lg">
 {selectedFeedback.user_name.charAt(0)}
 </div>
 <div>
 <h1 className="text-lg sm:text-xl font-medium text-slate-900 leading-tight">
 ...
 {selectedFeedback.status === "resolved" && (
 <span className="px-4 py-2 bg-emerald-50 text-emerald-700 border border-emerald-200 rounded-lg text-sm font-medium flex items-center gap-2 cursor-default">
 ...
 <span className="px-3 py-1 bg-blue-50 text-blue-700 border border-blue-200 rounded-md text-xs font-medium tracking-wide ">
 {selectedFeedback.category}
 </span>
 {selectedFeedback.rating && (
 <span className="flex items-center gap-1 bg-amber-50 text-amber-700 border border-amber-200 px-2 py-1 rounded-md text-sm font-medium">
 {selectedFeedback.rating}{" "}
