...
export default function HomePage() {
 ...
 <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-neutral-900 mb-6 sm:mb-8 max-w-4xl mx-auto leading-[1.1] animate-in fade-in slide-in-from-bottom-8 duration-1000">
 ...
 <h3 className="text-xl font-medium mb-4">Interview-Based</h3>
 ...
 <h3 className="text-xl font-medium mb-4">Manager Approvals</h3>
 <p className="text-neutral-500 leading-relaxed text-sm">
 ...
 <h3 className="text-xl font-medium mb-4">Data Privacy</h3>
 <p className="text-neutral-500 leading-relaxed text-sm">
