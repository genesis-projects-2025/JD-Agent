        ...
        <div className="flex gap-3 items-end">
          ...
          <div className="flex-1 relative">
            <textarea
              ...
              rows={1}
              className="w-full resize-none px-5 py-3.5 pr-12 bg-neutral-50 border-2 border-neutral-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all text-[15px] placeholder:text-neutral-400 disabled:opacity-50 disabled:cursor-not-allowed max-h-32"
