...
export default function JDPreviewPanel({
    ...
    const getSafeData = () => {
        const d = { ...s };
        if (d.key_responsibilities && !d.responsibilities)
            d.responsibilities = d.key_responsibilities;
        if (d.technical_skills && !d.skills) d.skills = d.technical_skills;
                ...
                <>
                                ...
                                {isEditing ? (
                                    ...
                                    <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
                                        ...
                                        {[
                                            ...
                                            {
                                                key: ["skills", "technical_skills", "required_skills"],
                                                label: "Skills / Competencies",
                                            },
                                            {
                                                key: ["tools", "tools_and_technologies"],
                                                label: "Tools & Technologies",
                                            },
                                        ].map((field) => {
                                            const currentKey = Array.isArray(field.key)
                                                ? field.key.find((k) => editedData[k]?.length > 0) ||
                                                field.key[0]
                                                : field.key;
                                            return (
                                                        ...
                                                        {(editedData[currentKey] || []).map(
                                                            (item: string, idx: number) => (
                                                                ...
                                                                >
                                                                    ...
                                                                    <button
                                                                        onClick={() =>
                                                                            handleRemoveArrayItem(currentKey, idx)
                                                                        }
                                    ...
                                    <>
                                        ...
                                        {(safeData.responsibilities?.length > 0 ||
                                            safeData.key_responsibilities?.length > 0) && (
                                                <SectionBlock icon={Target} title="Job Responsibilities">
                                                    <BulletList
                                                        items={
                                                            safeData.responsibilities ||
                                                            safeData.key_responsibilities
                                                        }
                                                    />
                                                </SectionBlock>
                                            )}
                                        ...
                                        {(safeData.skills?.length > 0 ||
                                            safeData.required_skills?.length > 0) && (
                                                <SectionBlock
                                                    icon={Briefcase}
                                                    title="Skills / Competencies"
                                                >
                                                    <div className="flex flex-wrap gap-2">
                                                        {(safeData.skills || safeData.required_skills).map(
                                        ...
                                        {/* Tools & Technologies */}
                                        {(safeData.tools?.length > 0 ||
                                            safeData.tools_and_technologies?.length > 0) && (
                                                <SectionBlock icon={Wrench} title="Tools & Technologies">
                                                    <div className="flex flex-wrap gap-2">
                                                        {(
                                                            safeData.tools || safeData.tools_and_technologies
                                        ...
                                        {(safeData.education || safeData.experience) && (
                                            ...
                                            >
                                                <div className="space-y-4">
                                                    {safeData.education && (
                                                        <div>
                                                            <h4 className="text-[10px] font-medium text-surface-400 mb-1">
                                                                Education
                                                            </h4>
                                        ...
                                        {safeData.working_relationships &&
                                            Object.keys(safeData.working_relationships).length >
                                            0 && (
                                                <SectionBlock
                                                    icon={Users}
                    ...
                    <div className="flex-shrink-0 p-4 border-t border-surface-100 bg-surface-50 space-y-2">
                        <button
                            ...
                            className={`w-full py-3.5 text-white rounded-md font-medium text-[13px] transition-all shadow-md active:scale-[0.98] flex items-center justify-center gap-2 ${saveSuccess
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                disabled={isSaving}
                                className={`flex-1 py-3 hover:bg-surface-50 border border-surface-200 rounded-md font-medium text-[12px] transition-all active:scale-[0.98] flex items-center justify-center gap-2 shadow-sm ${isEditing
                                    ...
                                    <div className="absolute bottom-full left-0 right-0 mb-2 bg-white border border-surface-200 rounded-md shadow-md z-[100] overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-200">
                                        <button
                                            onClick={(e) => {
                                                ...
                                                downloadJDPdfClient(safeData, title, dept);
                                            }}
