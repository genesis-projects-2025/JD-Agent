...
export default function Sidebar() {
 ...
 className={`md:hidden fixed top-4 left-4 z-40 p-2.5 rounded-md shadow-md transition-all active:scale-95 ${
 ...
 <h2 className="text-xs font-semibold text-neutral-500 tracking-wider">My JDs</h2>
 ...
 <span className={`w-1.5 h-1.5 rounded-md ${config.dotColor}`} />
