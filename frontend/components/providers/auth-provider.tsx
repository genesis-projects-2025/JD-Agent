...
export function AuthProvider({ children }: { children: React.ReactNode }) {
 ...
 <div className="bg-white p-8 rounded-md shadow-md max-w-md w-full text-center border border-red-100">
 <div className="w-16 h-16 bg-red-50 text-red-600 rounded-md flex items-center justify-center mx-auto mb-6">
 <ShieldAlert className="w-8 h-8" />
 </div>
 <h2 className="text-2xl font-medium text-surface-900 mb-2">
 Access Denied
 </h2>
 ...
 className="w-full py-3 bg-surface-100 text-surface-700 font-medium rounded-md hover:bg-surface-200 transition-colors"
 >
 Return to Home
 </button>
 </div>
