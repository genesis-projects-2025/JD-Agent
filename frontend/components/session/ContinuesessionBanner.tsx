...
function SessionCard({
 ...
 <div className={`w-2.5 h-2.5 rounded-md ${meta.dot}`} />
 </div>
 ...
 disabled={isResuming}
 className="flex-shrink-0 flex items-center justify-center gap-1.5 p-2 sm:px-4 sm:py-2 rounded-md text-[12px] font-medium transition-all active:scale-95 disabled:opacity-60 bg-blue-50 text-blue-700 border border-blue-100 hover:bg-blue-600 hover:text-white hover:border-blue-600 hover:shadow-md"
 >
 {isResuming ? (
...
export default function ContinueSessionBanner() {
 ...
 <div className="w-4 h-4 rounded-md bg-neutral-200 animate-pulse" />
 ...
 <div
 key={i}
 className="h-[68px] bg-neutral-100 rounded-md animate-pulse"
 />
 ))}
 </div>
 </div>
 ...
 if (error)
 return (
 <div className="w-full max-w-md mx-auto mb-6 px-4 py-3 bg-red-50 border border-red-100 rounded-md flex items-center justify-between">
 ...
 className="flex items-center gap-1 text-[11px] font-medium text-red-700"
 >
 ...
 <span className="text-[10px] font-medium px-1.5 py-0.5 bg-neutral-100 text-neutral-500 rounded-md">
 {sessions.length}
 </span>
 </div>
 {sessions.length > 2 && (
