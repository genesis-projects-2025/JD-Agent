...
export function ReviewRejectModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-lg mx-4 animate-in zoom-in-95 fade-in duration-300 overflow-hidden">
        {/* Header gradient */}
        <div className="bg-gradient-to-br from-red-500 via-red-600 to-orange-500 px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-white font-bold text-lg">Reject JD</h2>
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="space-y-3">
            ...
            <textarea
              ...
              className="w-full border border-surface-200 rounded-2xl p-4 text-sm text-surface-800 leading-relaxed focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none resize-none min-h-[120px] bg-surface-50 transition-shadow focus:shadow-md placeholder:text-surface-400"
              autoFocus
            />
          </div>
          ...
          <div className="flex gap-3 pt-2">
            <button
              ...
              className="flex-1 px-5 py-3.5 bg-surface-100 text-surface-600 rounded-xl font-bold text-sm hover:bg-surface-200 transition-colors disabled:opacity-50"
            >
              Cancel
            </button>
            <button
              ...
              className="flex-1 px-5 py-3.5 bg-red-600 text-white rounded-xl font-bold text-sm hover:bg-red-700 transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5 disabled:opacity-50 disabled:hover:translate-y-0 flex items-center justify-center gap-2"
            >
              {isSubmitting ? (
